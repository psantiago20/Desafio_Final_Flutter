...
class _PrescriptionsScreenState extends ConsumerState<PrescriptionsScreen> {
  ...
  void _showPrescriptionOverlay(BuildContext context, String html) {
    // Inject responsive fixes for older or hardcoded HTML generated by the backend
    final responsiveHtml = html
        .replaceAll('display: flex; justify-content: space-between;', 'display: block;')
        .replaceAll('display: flex; flex-wrap: wrap; justify-content: space-between;', 'display: block;')
        .replaceAll('width: 300px;', 'width: auto; margin-top: 20px;')
        .replaceAll('text-align: right; min-width: 150px;', 'text-align: left; margin-top: 20px;')
        .replaceAll('text-align: right; flex: 1; min-width: 180px; max-width: 300px;', 'text-align: center; margin-top: 20px;');
            ...
            children: [
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: HtmlWidget(responsiveHtml),
                ),
              ),
              Padding(
                padding: const EdgeInsets.all(20),
